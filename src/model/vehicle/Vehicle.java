...
public abstract class Vehicle {
    ...
    /**
     * Trả về key âm thanh của loại xe này.
     * Mỗi subclass override để khai báo âm thanh riêng.
     * Trả về null nếu loại xe không có âm thanh.
     *
     * Key phải khớp với tên đã load trong SoundManager.initVehicleSounds():
     *   "car", "motorbike", "bicycle", "ambulance", "firetruck"
     */
    ...
    // ─────────────────────────────────────────────────────────────
    // GETTERS / SETTERS (giữ nguyên toàn bộ)
    // ─────────────────────────────────────────────────────────────
    ...
    public void setTurnType(TurnType turnType) { this.turnType = turnType; }
    ...
    public void setTurning(boolean turning) { this.turning = turning; }
    public Direction getTargetDirection() { return targetDirection; }
    public void setTargetDirection(Direction targetDirection) { this.targetDirection = targetDirection; }
    ...
    public void setChangingLane(boolean changingLane) { this.changingLane = changingLane; }
    public Lane getTargetLane() { return targetLane; }
    public void setTargetLane(Lane targetLane) { this.targetLane = targetLane; }
    public int getLaneChangeCooldown() { return laneChangeCooldown; }
    public void setLaneChangeCooldown(int laneChangeCooldown) { this.laneChangeCooldown = laneChangeCooldown; }
