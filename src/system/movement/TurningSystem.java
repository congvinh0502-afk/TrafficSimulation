...
public class TurningSystem {
    ...
    private static final double TURN_ZONE = config.Constants.LANE_WIDTH + 15.0; // 65 px — match v0.1.2 turnZone
    ...
    private void tryFinish(Vehicle v) {
        ...
        // homeIntersectionX được giữ nguyên (set bởi VehicleSpawnManager).
        // Trong chế độ đa giao lộ (network_v2), có thể gọi NetworkLayout.nearestIntersectionX ở đây.
